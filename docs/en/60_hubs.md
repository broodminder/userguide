...
<div align="center">
  <div id="yt-Uo9sy90Xrfk" style="position:relative; display:inline-block; cursor:pointer;">
    <img src="https://img.youtube.com/vi/Uo9sy90Xrfk/0.jpg" alt="YouTube video" style="display:block;">
...
<script>
document.getElementById("yt-Uo9sy90Xrfk").addEventListener("click", function() {
  this.innerHTML = '<iframe width="560" height="315" src="https://www.youtube.com/embed/Uo9sy90Xrfk?autoplay=1" frameborder="0" allowfullscreen></iframe>';
});
</script>
