...
#### 5.1 Place the scale in the shade
...
#### 5.2 Get the Broodminder-W level
...
#### 5.3 Typical installation, not as accurate
...
#### 5.4 Better installation, more accurate
